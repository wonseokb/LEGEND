...
G4double TPBthickness = 0.3*um;//half
...
G4VPhysicalVolume* Project1DetectorConstruction::makeMode2()//***
{
  ...
  //for only TPB Test
  new G4PVPlacement(0, G4ThreeVector(), pmtLogicalVolume, "pmt3", experimentalHallLogicalVolume, false, 0);  
...
{ 
  ...
  //for only TPB Test
  G4Tubs* photocathodeSolid = new G4Tubs("photocathodeSolid", EJ280Radius-pmtThickness, EJ280Radius, EJ280Length, 0.0, CLHEP::twopi * rad);
