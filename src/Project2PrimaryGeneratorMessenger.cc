...
Project2PrimaryGeneratorMessenger::Project2PrimaryGeneratorMessenger(Project2PrimaryGeneratorAction* Gun)
...
Project2PrimaryGeneratorMessenger::~Project2PrimaryGeneratorMessenger()
{ 
  /*
  delete cryDir;
  delete inputCmd;
...
void Project2PrimaryGeneratorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  /*	
  if(command == inputCmd) {
