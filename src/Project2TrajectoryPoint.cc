...
G4Allocator<Project2TrajectoryPoint> trajectoryPointAllocator;

Project2TrajectoryPoint::Project2TrajectoryPoint()
    : fTime(0.0), fMomentum(0.0, 0.0, 0.0),
      fStepStatus(fUndefined), fVolumeName("") {}

Project2TrajectoryPoint::Project2TrajectoryPoint(const G4Step* aStep)
...
Project2TrajectoryPoint::Project2TrajectoryPoint(const G4Track* aTrack)
...
Project2TrajectoryPoint::Project2TrajectoryPoint(const Project2TrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* Project2TrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* Project2TrajectoryPoint::CreateAttValues() const
{
