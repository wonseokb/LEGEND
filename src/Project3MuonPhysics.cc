...
Project3MuonPhysics::Project3MuonPhysics(const G4String& name)
...
Project3MuonPhysics::~Project3MuonPhysics() {}

void Project3MuonPhysics::ConstructParticle()
{
...
void Project3MuonPhysics::ConstructProcess()
{
