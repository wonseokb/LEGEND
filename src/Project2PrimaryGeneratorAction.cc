...
Project2PrimaryGeneratorAction::Project2PrimaryGeneratorAction(const char *inputFilename)
    :fuseCRY(false)
{
  ...
  gunMessenger = new Project2PrimaryGeneratorMessenger(this);
}

Project2PrimaryGeneratorAction::~Project2PrimaryGeneratorAction()
{
  delete particleGun;
  delete generalParticleSource;
}
/*
void Project2PrimaryGeneratorAction::useCRY(G4bool useCry)
{
  fuseCRY = useCry;
}

void Project2PrimaryGeneratorAction::InputCRY()
{
  inputState = 1;
}

void Project2PrimaryGeneratorAction::UpdateCRY(std::string* MessInput)
{
...
void Project2PrimaryGeneratorAction::CRYFromFile(G4String newValue)
{
  std::ifstream inputFile;
...
void Project2PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent){
  if(fuseCRY){
    if (inputState != 0) {
