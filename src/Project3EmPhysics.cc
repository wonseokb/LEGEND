...
Project3EmPhysics::Project3EmPhysics(const G4String& name)
...
Project3EmPhysics::~Project3EmPhysics() {}

void Project3EmPhysics::ConstructParticle()
{
...
void Project3EmPhysics::ConstructProcess()
{
