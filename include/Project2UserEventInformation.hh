...
#ifndef Project2UserEventInformation_h
#define Project2UserEventInformation_h 1

class Project2UserEventInformation : public G4VUserEventInformation
{
  public:
    Project2UserEventInformation();
    virtual ~Project2UserEventInformation();
