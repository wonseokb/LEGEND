#ifndef Project1PmtSd_h
#define Project1PmtSd_h 1
...
class Project1PmtSd : public G4VSensitiveDetector
{

  public:
    Project1PmtSd(G4String name);
    virtual ~Project1PmtSd();
  ...
  private:
    Project1PmtHitsCollection* pmtHitsCollection;
